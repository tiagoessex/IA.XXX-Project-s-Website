...
// **********************************
//
//  RETURN AN ABNORMAL ENTITY STILL TO BE VALIDATED
//
...
$query = "
  ...
  from 
    entidade_anomalias 
  where 
    entidade_anomalias.valid is not null";
...
from 
  entidade_anomalias AS dups
left JOIN entidade AS ent1 on (dups.id_entidade_1 = ent1.id_entidade)
left join entidade AS ent2 on (dups.id_entidade_2 = ent2.id_entidade)
WHERE 
  dups.VALID IS null
LIMIT 1
";
