...
<div class="container-fluid"> 
  ...
  <br>
    ...
    Validação Manual de Entidades Duplicadas
  </h1>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body modal-body-help">
            <p>
              Nesta página poderá proceder à validação manual das entidades identificadas como duplicadas.
            </p>
            <p>
              As potenciais entidades duplicadas são apresentadas aos pares, cabendo ao utilizador decidir se são mesmo duplicadas.
            </p>
            <p>
              Existem 3 hipóteses:
              <ul>
                <li><i><mark style="background-color: #99FF00;border-radius: 5px; padding: 2px;color:black;">Válido</mark></i> - se duplicados</li>
                <li><i><mark style="background-color: #FF3300;border-radius: 5px; padding: 2px;color:black;">Inválido</mark></i> - se não duplicados</li>
...
<script>
    ...
    function getEnt2Validate() {
      $('.table').html('');
      $.ajax({  
                   url:"<?php echo DOMAIN_URL; ?>entidades/srv/getent2validate.php",  
                    method:"POST",
                    //data:{},
                    cache: false,
                    dataType:"text", 
    ...
    function validate(isvalid) {
        $.ajax({  
                   url:"<?php echo DOMAIN_URL; ?>entidades/srv/validaduplicado.php",  
                    method:"POST",
