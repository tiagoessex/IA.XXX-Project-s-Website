...
<div class="container-fluid">
    ...
    <div class="row col-sm-6">
        <h3 style="background-color: #99CCFF;border-radius: 10px; padding: 5px;color:black;">
            <b>Número de entidades duplicadas: </b>
            <?php echo $counter; ?>
        </h3>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-help text-justify">
                    <p>
                        Nesta página poderá consultar todas as entidades identificadas como duplicadas.
                    </p>

                    <p>
                        Os duplicados estão agrupados em grupos de 2: linha colorida + linha sem cor.
                    </p>

                    <p>
                        <mark>
                Note que estas não se encontram ainda validadas, e portanto, algumas poderão estar incorrectamente identificadas como duplicadas.
              </mark>
                    </p>
                </div>
...
<script>
   var datatable = null;
    ...
    $( document ).ready(function() {
      //$(".counter").html(setCommas(<?php echo $counter; ?>));
  ...
  ShowTable();
    ...
    function getAllDuplicates() {
        $.ajax({  
                   url:"<?php echo DOMAIN_URL; ?>entidades/srv/getalldups.php",  
                    method:"POST",
